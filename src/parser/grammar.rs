                ...
                let start_pos = pos;
                {
                    ...
                    match seq_res {
                        Matched(pos, n) => {
                            {
                                let match_str = &input[start_pos..pos];
                                Matched(pos, { runtime::Value::Number(n) })
                            }
                        }
                        Failed => Failed,
                    }
                                                ...
                                                Matched(pos, _) => {
                                                    {
                                                        ...
                                                        Matched(pos,
                                                                {
                                                                    runtime::Value::Object(runtime::Object::Null)
                                                                })
                                                    }
                                                }
                                                Failed => Failed,
